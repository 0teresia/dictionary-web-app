...
import Footer from './Footer';
    ...
    return (
        <div className="mx-10 sm:max-w-375px md:max-w-768px lg:max-w-1440px">
            <input
                type="text"
                value={word}
                onChange={handleInputChange}
                className={`w-full text-gray-900 dark:text-white bg-gray-200 dark:bg-gray-900 outline-none rounded-lg px-3 py-3 shadow focus:ring focus:ring-purple-500 ${
